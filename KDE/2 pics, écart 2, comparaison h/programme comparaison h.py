...
true_dens = 0.35 * norm(0, 1).pdf(X_plot[:, 0]) + 0.65 * norm(5, 2).pdf(X_plot[:, 0])
...
plt.savefig('2 pics (écart 2 sur le pic 2), h=0.5, N=10000.png', dpi=500)